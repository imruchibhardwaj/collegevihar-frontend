...
<!-- Top Online Courses Section -->
<section class="top-online-course section-mb py-16 bg-white">
  <div class="top-online-course-section">
    <div class="wrapper-course container mx-auto px-4">
      <div class="top-section flex justify-between items-center mb-8">
        <h2 class="text-3xl md:text-4xl font-bold text-blue-800">Top Online Courses</h2>
        <a href="https://www.onlinemanipal.com/all-courses" class="text-blue-700 border border-blue-700 px-5 py-2 rounded-full hover:bg-blue-700 hover:text-white transition">View All Courses</a>
      </div>
      <div class="top-course-slider">
        <!-- Course Slide -->
        <!-- Course 1 -->
<div class="line-item border border-gray-200 rounded-lg overflow-hidden shadow-md bg-white">
  <a href="/online-mba-sikkim-manipal-university" class="block">
    ...
    <div class="p-4 space-y-2">
      <div class="flex justify-between items-center">
        <h3 class="font-semibold text-lg text-gray-800">Master of Business Administration</h3>
        <div class="flex items-center text-yellow-500">
          <span class="mr-1 text-sm font-medium text-gray-600">4.5</span>
          <img src="https://www.onlinemanipal.com/wp-content/themes/flamingo/assets/images/icons/star.svg" alt="rating" width="14" height="14">
        </div>
      </div>
      <div class="flex items-center text-sm text-gray-600 space-x-4">
        <div class="flex items-center">
          <img src="https://www.onlinemanipal.com/wp-content/themes/flamingo/assets/images/icons/duration.svg" width="18" height="18" class="mr-1">
          <span>24 months</span>
        </div>
        <span class="text-gray-400">•</span>
        <div class="flex items-center">
          <img src="https://www.onlinemanipal.com/wp-content/themes/flamingo/assets/images/icons/fees.svg" width="18" height="18" class="mr-1">
...
<div class="line-item border border-gray-200 rounded-lg overflow-hidden shadow-md bg-white">
  <a href="#" class="block">
    <img src="https://www.onlinemanipal.com/wp-content/uploads/2025/03/BCA-SMU.png" alt="BCA" class="w-full h-48 object-contain bg-gray-50">
    <div class="p-4 space-y-2">
      <div class="flex justify-between items-center">
        <h3 class="font-semibold text-lg text-gray-800">Bachelor of Computer Applications</h3>
        <div class="flex items-center text-yellow-500">
...
<div class="line-item border border-gray-200 rounded-lg overflow-hidden shadow-md bg-white">
  <a href="#" class="block">
    <img src="https://www.onlinemanipal.com/wp-content/uploads/2025/03/BBA-SMU.png" alt="BBA" class="w-full h-48 object-contain bg-gray-50">
    <div class="p-4 space-y-2">
      <div class="flex justify-between items-center">
        <h3 class="font-semibold text-lg text-gray-800">Bachelor of Business Administration</h3>
        <div class="flex items-center text-yellow-500">
